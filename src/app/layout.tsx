...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <head>
        <link rel="preload" href="/fonts/Boxing-Regular.woff2" as="font" type="font/woff2" crossOrigin="anonymous" />
        <link rel="preload" href="/fonts/Paquito-Regular.woff2" as="font" type="font/woff2" crossOrigin="anonymous" />
